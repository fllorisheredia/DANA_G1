...
<header class="main-header">
    ...
    <div class="header-container container d-flex justify-content-between align-items-center py-3" id="visor">
        <nav class="main-nav d-flex gap-3">
            <a href="../index.php" class="nav-link">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
                    <defs>
                        <path id="solarHomeBoldDuotone0" d="M10.75 9.5a1.25 1.25 0 1 1 2.5 0a1.25 1.25 0 0 1-2.5 0" />
                    </defs>
            ...
            <a href="usuariosAdmin.php" class="nav-link   " onclick="cargarPagina('/DANA0/admin/usuariosAdmin.php')">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
                    <g fill="currentColor">
            ...
            <a href="productosAdmin.php" class="nav-link">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
                    <path fill="currentColor"
            ...
            <a class="nav-link" onclick="cargarPagina('/DANA0/admin/pedidosAdmin.php')" id="visor">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
                    <path fill="currentColor"
