...
<div x-data="{ isOpen: false }" class="relative inline-block ">
    ...
    <div x-show="isOpen" @click.away="isOpen = false" x-transition:enter="transition ease-out duration-100"
        ...
        <a onclick="parent.cargarVista('../usuarios/perfil.php'); return false;" @click="isOpen = false"
        class="flex items-center p-3 text-sm text-gray-600 capitalize transition-colors duration-300 transform dark:text-gray-300 hover:bg-violet-700 hover:text-white dark:hover:bg-violet-700 dark:hover:text-white cursor-pointer">
            <svg class="w-5 h-5 mx-1" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path
        ...
        <a onclick="parent.cargarVista('../mensajes/chat.php'); return false;" @click="isOpen = false"
        class="flex items-center p-3 text-sm text-gray-600 capitalize transition-colors duration-300 transform dark:text-gray-300 hover:bg-violet-700 hover:text-white dark:hover:bg-violet-700 dark:hover:text-white cursor-pointer">
        ...
        <a onclick="parent.cargarVista('../cliente/contacto_cliente.php'); return false;" @click="isOpen = false"
        class="flex items-center p-3 text-sm text-gray-600 capitalize transition-colors duration-300 transform dark:text-gray-300 hover:bg-violet-700 hover:text-white dark:hover:bg-violet-700 dark:hover:text-white cursor-pointer">
            <svg class="w-5 h-5 mx-1" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path
        ...
        <a href="/DANA_G1/usuarios/logout.php" @click="isOpen = false"
        class="flex items-center p-3 text-sm text-gray-600 capitalize transition-colors duration-300 transform dark:text-gray-300 hover:bg-violet-700 hover:text-white dark:hover:bg-violet-700 dark:hover:text-white cursor-pointer">
            <svg class="w-5 h-5 mx-1" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path
