...
<main class="min-h-screen bg-base-100 py-10 px-4 md:px-12 lg:px-24">
    <section
        class="max-w-4xl mx-auto bg-white dark:bg-neutral rounded-lg shadow-md p-8 space-y-6 border border-gray-200 dark:border-gray-700">
        <h1 class="text-3xl font-bold text-violet-700 text-center mb-4">Política de Privacidad</h1>
        ...
        <div class="space-y-6">
            <div>
                <h2 class="text-xl font-semibold text-violet-600">1. Información que recopilamos</h2>
            ...
            <div>
                <h2 class="text-xl font-semibold text-violet-600">2. Finalidad del tratamiento</h2>
                <p class="text-gray-800 text-justify">
            ...
            <div>
                <h2 class="text-xl font-semibold text-violet-600">3. Derechos de los usuarios</h2>
                <p class="text-gray-800 text-justify">
            ...
            <div>
                <h2 class="text-xl font-semibold text-violet-600">4. Uso de cookies</h2>
                <p class="text-gray-800 text-justify">
            ...
            <div>
                <h2 class="text-xl font-semibold text-violet-600">5. Enlaces a terceros</h2>
                <p class="text-gray-800 text-justify">
            ...
            <div>
                <h2 class="text-xl font-semibold text-violet-600">6. Modificaciones de esta política</h2>
                <p class="text-gray-800 text-justify">
