<footer class="footer sm:footer-horizontal bg-base-200 text-base-content p-10 mt-auto">
    ...
    <nav>
        ...
        <a href="solicitar_producto.php">Solicitar Porducto</a>
        <a href="quienes_somos_cliente.php">Quiénes Somos</a>
        <a href="contacto_cliente.php">Contacto</a> <!-- Pendiente a cambiar!!!!!!!!!!!!!!!!!!!!!!! -->
    </nav>
